...
CATEGORY_DICT = {
    ...
    8: 'suit',
    9: 'box',
    10: 'motor'}  # NOTE: set the categories in your videos here,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--obj', type=str, default='../MOT17-04-SDP-raw.mp4', help='video NAME or images FOLDER NAME')

    parser.add_argument('--save_txt', type=bool, default=False, help='whether save txt')

    parser.add_argument('--tracker', type=str, default='deepsort', help='sort, deepsort, etc')
    parser.add_argument('--model_path', type=str, default='../weights/best_mydata.pt', help='model path')
